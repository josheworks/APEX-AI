...
"- ALWAYS use get_current_date when the user asks for today's date, "
"the current date, current day, current month, current year, "
"or asks what date/year/month it is.\n"
"- ALWAYS use get_current_time when the user asks for the current "
"time, present time, or what time it is now.\n"
"- NEVER answer current date, month, year, or time questions from "
"your model knowledge or memory.\n"
"- The result returned by get_current_date is the authoritative "
"current date for APEX.\n"
"- The result returned by get_current_time is the authoritative "
"current time for APEX.\n"
"- NEVER claim that the current year is 2024, 2025, or any other "
"year unless that year came from the appropriate current-date tool "
"or was explicitly provided by the user.\n"
